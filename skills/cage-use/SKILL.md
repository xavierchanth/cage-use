...
Use the configured cage-use MCP server on the target host. It provides app-scoped tools modeled on macOS Computer Use. Each app ID identifies a Cage session owned by the current MCP connection.
