"""Cage session lifecycle, capture, and input behavior."""
...
class CageDesktop:
    """Own only sessions launched by this instance; never attach by port."""
    ...
    def launch(self, executable: str, args: list[str]) -> dict:
        with self.lock:
            ...
            app = uuid.uuid4().hex
            directory = tempfile.TemporaryDirectory(prefix="cage-use-")
